...
export const LENDER_PRODUCT_REQUEST = "LENDER_PRODUCT_REQUEST";
export const LENDER_PRODUCT_SUCCESS = "LENDER_PRODUCT_SUCCESS";
export const LENDER_PRODUCT_FAIL = "LENDER_PRODUCT_FAIL";

// export const LENDER_EDIT_PRODUCT_REQUEST = "LENDER_EDIT_PRODUCT_REQUEST";
// export const LENDER_EDIT_PRODUCT_SUCCESS = "LENDER_EDIT_PRODUCT_SUCCESS";
// export const LENDER_EDIT_PRODUCT_RESET = "LENDER_EDIT_PRODUCT_RESET";
// export const LENDER_EDIT_PRODUCT_FAIL = "LENDER_EDIT_PRODUCT_FAIL";

export const LENDER_DELETE_PRODUCT_REQUEST = "LENDER_DELETE_PRODUCT_REQUEST";
export const LENDER_DELETE_PRODUCT_SUCCESS = "LENDER_DELETE_PRODUCT_SUCCESS";
export const LENDER_DELETE_PRODUCT_RESET = "LENDER_DELETE_PRODUCT_RESET";
export const LENDER_DELETE_PRODUCT_FAIL = "LENDER_DELETE_PRODUCT_FAIL";
